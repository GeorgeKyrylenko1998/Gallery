...
protocol PhotosCollectionLayoutDelegate: class {
...
class PhotosCollectionViewLayout: UICollectionViewFlowLayout{
    ...
    weak var delegate: PhotosCollectionLayoutDelegate?
    ...
    init(with delegate: PhotosCollectionLayoutDelegate?) {
    ...
    override func prepare() {
        ...
        for index in 0 ..< numberOfItems {
            ...
            let itemSize = delegate.collectionLayout(self, sizeForItemAt: indexPath)
